              ...
              <div class="form-group">
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group">
                      <label for="c_diff_country" class="text-black">Provincias <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        <label for="c_diff_companyname" class="text-black">Destinatario </label>
                    ...
                    <div class="form-group row">
                      <div class="col-md-6">
                        <label for="c_diff_state_country" class="text-black">Provincia <span class="text-danger">*</span></label>
